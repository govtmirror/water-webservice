...
class ApiControllerTest extends WebTestCase
{
    ...
    * @group new
    */
    function testGetObjectVariables(){
      $series = new Seriescatalog();
      $series->setParentid(14097);
      $series->setIsfolder(0);
      $series->setSortorder(0);
      ...
      $arrayKeys = array('parentid','isfolder','sortorder','iconname','name','siteid','units','timeinterval','parameter','tablename','provider','connectionstring','expression','notes','enabled', 'id');
      $apiController = new ApiController();
      $result = $apiController->getObjectVariables($seriesArray);
