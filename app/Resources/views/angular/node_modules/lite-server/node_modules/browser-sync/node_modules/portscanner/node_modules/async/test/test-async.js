...
exports['test_waterfall'] = function(test){
    test.expect(6);
    var call_order = [];
...
exports['test_waterfall empty array'] = function(test){
    async.test_waterfall([], function(err){
        test.done();
    });
};

exports['test_waterfall no callback'] = function(test){
    async.test_waterfall([
...
exports['test_waterfall async'] = function(test){
    var call_order = [];
    async.test_waterfall([
        function(callback){
            call_order.push(1);
...
exports['test_waterfall error'] = function(test){
    test.expect(1);
    async.test_waterfall([
        function(callback){
            callback('error');
...
exports['test_waterfall multiple callback calls'] = function(test){
    var call_order = [];
    var arr = [
        function(callback){
            call_order.push(1);
